...
<div class="form-container">
    <div class="form-card">
        <div class="card-header-custom">
            <h4>
                <i class="fas fa-edit"></i> <span data-i18n="edit_choir_member_title">Edit Choir Member</span>
            </h4>
            <p><span data-i18n="edit_choir_member_desc">Update choir member information</span></p>
        </div>
            ...
            <form action="{{ route('choir-members.update', $choir_member->id) }}" method="POST">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="first_name" class="form-control" required 
                               value="{{ $choir_member->first_name }}" placeholder="{{ __('Enter first name') }}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="last_name" class="form-control" required 
                               value="{{ $choir_member->last_name }}" placeholder="{{ __('Enter last name') }}">
                    </div>
                    ...
                    <div class="form-group-full">
                        ...
                        <textarea name="address" rows="2" class="form-control" 
                                  placeholder="{{ __('Complete address of the member') }}">{{ $choir_member->address }}</textarea>
                    </div>
                ...
                <div class="button-group">
                    ...
                    <button type="submit" class="btn-submit">
                        <i class="fas fa-save"></i> <span data-i18n="update_choir_member">Update Choir Member</span>
                    </button>
                </div>
            </form>
        </div>
