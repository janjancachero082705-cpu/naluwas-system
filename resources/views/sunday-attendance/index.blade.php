...
<div class="sa container-fluid px-0">
    ...
    <header class="sa-head">
        ...
        <div class="sa-head-actions">
            ...
            <button type="button" class="sa-btn sa-btn-primary" onclick="saveAttendance(true)">
...
<script>
    ...
    function isSunday(dateStr) {
        ...
        // Force local time — avoids UTC shifting issue
    ...
    function saveAttendance(manual) {
        ...
        // ⭐ SUNDAY-ONLY GUARD — final defense before POST
        if (!isSunday(serviceDate)) {
            isSaving = false;
        ...
        .then(async response => {
            ...
            if (!contentType.includes('application/json')) {
                ...
                throw new Error('Server did not return JSON. Check the controller returns JSON for AJAX.');
            }
        ...
        .then(data => {
            ...
            if (data.success) {
                ...
                // ⭐ Manual save → redirect to records after short delay
                if (manual) {
                    setTimeout(() => {
    ...
    function goToPrevWeek() {
        ...
        window.location.href = "{{ route('sunday-attendance.index') }}?date=" + y + '-' + m + '-' + d;
    }
