    ...
    <div class="edit-hero">
        <div class="hero-content">
            <div class="hero-left">
                ...
                <div class="hero-text">
                    <h1><span data-i18n="edit_member">{{ __("Edit Member") }}</span></h1>
                    <p class="hero-sub">
            ...
            <div class="hero-actions">
                <a href="{{ route('members.show', $member->id) }}" class="btn-hero-edit btn-hero-edit-ghost">
                    <i class="fas fa-eye"></i> <span data-i18n="view_profile">{{ __("View Profile") }}</span>
                </a>
                <a href="{{ route('members.index') }}" class="btn-hero-edit btn-hero-edit-white">
                    <i class="fas fa-arrow-left"></i> <span data-i18n="back">{{ __("Back") }}</span>
                </a>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-10 mx-auto">
            <div class="edit-card">
                <div class="edit-card-header">
                    <h5>
                        <i class="fas fa-user-edit"></i> <span data-i18n="edit_member_information">{{ __("Edit Member Information") }}</span>
                    </h5>
                    <span class="member-id-badge">
                        <i class="fas fa-clock"></i> <span data-i18n="last_updated">{{ __("Last updated:") }}</span> {{ $member->updated_at ? \Carbon\Carbon::parse($member->updated_at)->diffForHumans() : __("Never") }}
                    </span>
                </div>
                        ...
                        <div class="row g-4">
                            <div class="col-12">
                                <h6 class="fw-bold text-primary mb-3" style="font-family: 'Inter', sans-serif;">
                                    <i class="fas fa-user-circle me-2"></i> <span data-i18n="personal_information">{{ __("Personal Information") }}</span>
                                </h6>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">
                                        <i class="fas fa-user"></i> <span data-i18n="first_name">{{ __("First Name") }}</span> <span class="required">*</span>
                                    </label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">
                                        <i class="fas fa-user"></i> <span data-i18n="last_name">{{ __("Last Name") }}</span> <span class="required">*</span>
                                    </label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div style="font-size: 0.7rem; color: #EF4444; margin-top: 4px; background: rgba(239, 68, 68, 0.08); padding: 4px 10px; border-radius: 6px;">
                                        <i class="fas fa-database"></i> <span data-i18n="current_db_value">{{ __("Current value in database:") }}</span> <strong>{{ $member->gender ?? 'null' }}</strong>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">
                                        <i class="fas fa-phone"></i> <span data-i18n="phone_number">{{ __("Phone Number") }}</span>
                                    </label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">
                                        <i class="fas fa-envelope"></i> <span data-i18n="email_address">{{ __("Email Address") }}</span>
                                    </label>
                            ...
                            <div class="col-12 mt-3">
                                <h6 class="fw-bold text-primary mb-3" style="font-family: 'Inter', sans-serif;">
                                    <i class="fas fa-tags me-2"></i> <span data-i18n="roles_responsibilities">{{ __("Roles & Responsibilities") }}</span>
                                </h6>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label class="form-label">
                                        <i class="fas fa-shield-alt"></i> <span data-i18n="assign_roles">{{ __("Assign Roles") }}</span>
                                    </label>
                                    ...
                                    <div class="form-text">
                                        <i class="fas fa-info-circle"></i> <span data-i18n="select_multiple_hint">{{ __("Hold") }}</span> <strong>Ctrl</strong> <span data-i18n="windows_hint">{{ __("(Windows) or") }}</span> <strong>Cmd</strong> <span data-i18n="mac_hint">{{ __("(Mac) to select multiple roles") }}</span>
                                    </div>
                                    @error('roles')
                                        <div class="invalid-feedback"><i class="fas fa-exclamation-circle"></i> {{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-12 mt-3">
                                <h6 class="fw-bold text-purple mb-3" style="font-family: 'Inter', sans-serif; color: #8B5CF6;">
                                    <i class="fas fa-music me-2"></i> <span data-i18n="choir_information">{{ __("Choir Information") }}</span>
                                </h6>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="choir-section">
                                    <div class="choir-title">
                                        <i class="fas fa-users"></i> <span data-i18n="choir_assignment">{{ __("Choir Assignment") }}</span>
                                    </div>
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label">
                                                    <i class="fas fa-layer-group"></i> <span data-i18n="choir_group">{{ __("Choir Group") }}</span>
                                                </label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label">
                                                    <i class="fas fa-microphone-alt"></i> <span data-i18n="choir_role">{{ __("Choir Role") }}</span>
                                                </label>
                        ...
                        <div class="form-actions">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <button type="submit" class="btn-update-edit">
                                    <i class="fas fa-save"></i> <span data-i18n="update_member">{{ __("Update Member") }}</span>
                                </button>
                            </div>
                        </div>
                    </form>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        window.addEventListener('beforeunload', function(e) {
            if (formChanged) {
                e.preventDefault();
                e.returnValue = window.t ? window.t('unsaved_changes', 'You have unsaved changes. Are you sure you want to leave?') : 'You have unsaved changes. Are you sure you want to leave?';
